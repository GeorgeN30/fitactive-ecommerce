const statusStyles: Record<string, { bg: string; text: string; dot: string }> = {
  ...
  Inactive: { bg: "bg-slate-200", text: "text-slate-700", dot: "bg-slate-500" },
  ...
  Preparing: { bg: "bg-amber-100", text: "text-amber-700", dot: "bg-amber-500" },
  Pending: { bg: "bg-slate-200", text: "text-slate-700", dot: "bg-slate-500" },
  ...
  Customer: { bg: "bg-slate-100", text: "text-slate-700", dot: "bg-slate-500" },
  Admin: { bg: "bg-blue-100", text: "text-blue-700", dot: "bg-blue-500" },
  Entry: { bg: "bg-emerald-100", text: "text-emerald-700", dot: "bg-emerald-500" },
  Exit: { bg: "bg-amber-100", text: "text-amber-700", dot: "bg-amber-500" },
  Adjustment: { bg: "bg-blue-100", text: "text-blue-700", dot: "bg-blue-500" },
};
...
export default function StatusBadge({ status, label }: StatusBadgeProps) {
  ...
  return (
    <span className={`px-3 py-1 rounded-full text-[11px] font-bold ${style.bg} ${style.text} flex items-center gap-1.5 w-fit`}>
