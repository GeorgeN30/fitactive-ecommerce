      ...
      {growth !== undefined && (
        <div className="mt-4 flex items-center justify-between">
          <div className="flex items-center gap-1 text-brand-green font-bold text-xs">
            <i
              className={`fa-solid fa-arrow-trend-${growth >= 0 ? "up" : "down"} text-[10px]`}
            />
            <span>
              {growth >= 0 ? "+" : ""}
              {growth}%
          ...
          <svg
            className="w-16 h-6 text-brand-green/60"
            viewBox="0 0 100 30"
            fill="none"
            stroke="currentColor"
            strokeWidth="2.5"
          >
            <path
              d={
                growth >= 0
                  ? "M0 25 L20 22 L40 24 L60 15 L80 18 L100 5"
                  : "M0 5 L20 8 L40 6 L60 15 L80 12 L100 25"
              }
              strokeLinecap="round"
