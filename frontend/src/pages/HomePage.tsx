...
export default function HomePage() {
  ...
  const panelPath =
    user?.role === "admin" ? "/admin" : isInventoryUser ? "/inventory" : null;
  const panelLabel =
    user?.role === "admin"
    ...
    <AppLayout>
      <div className="w-full pb-10 bg-[#f8f9fa] dark:bg-brand-dark-bg text-gray-900 dark:text-white font-sans">
        <section className="relative w-full h-[500px] md:h-[600px] bg-gray-900 text-white flex items-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full">
            {panelPath && (
              <Link
                to={panelPath}
                className="inline-flex items-center gap-2 px-4 py-2 bg-white/95 text-gray-900 text-xs font-bold rounded-xl mb-5 shadow-lg hover:bg-brand-green transition-colors"
              >
            ...
            <p className="text-gray-300 text-sm sm:text-base max-w-lg mb-8 leading-relaxed">
              Colecciones técnicas de alto rendimiento con tecnología de
              probador virtual 3D y 2D integrada. El ajuste perfecto
              garantizado.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                to="/catalogo"
                className="px-6 py-3 bg-transparent border border-gray-400 text-white font-bold rounded-md hover:border-white transition text-center flex items-center justify-center"
              >
                Ver catálogo
              </Link>
            </div>
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
          <h2 className="text-2xl font-extrabold mb-8 dark:text-white">
            Explora por deporte
          </h2>
            ...
            {[
              {
                id: "1",
                name: "Running",
                img: "https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=200&q=80",
              },
              {
                id: "2",
                name: "Gym",
                img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSdEOvdR6yAzYhKRjt4QK6_yG-WgTQyw6wMM3VCEvkJJnOj4hyZo_TT_38&s=10",
              },
              {
                id: "3",
                name: "Yoga",
              ...
              },
              {
                id: "4",
                name: "CrossFit",
                img: "https://www.clarin.com/2024/02/19/XKwmLCMfV_1200x0__1.jpg",
              },
              {
                id: "5",
                name: "Ciclismo",
                img: "https://images.unsplash.com/photo-1517649763962-0c623066013b?w=200&q=80",
              },
              {
                id: "6",
                name: "Natación",
                img: "https://www.arenaperu.com/arquivos/Mujer-Entrenamiento-Natacion.jpg?v=638011786246170000",
              },
            ].map((sport, index) => (
              <div
                key={index}
              ...
              >
                ...
                <span className="text-xs md:text-sm font-bold dark:text-gray-200">
                  {sport.name}
                </span>
              </div>
            ))}
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 py-8">
          <div className="mb-6">
            <span className="text-brand-green text-[10px] font-extrabold tracking-widest uppercase">
              High Performance
            </span>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mt-1 gap-2">
              ...
              <Link
                to="/catalogo"
                className="text-sm font-bold text-gray-600 dark:text-gray-400 hover:text-brand-green flex items-center group"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={index}
                className="bg-white dark:bg-brand-card-dark rounded-2xl p-4 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100 dark:border-gray-800 flex flex-col"
              >
                ...
                <h3 className="font-extrabold text-gray-900 dark:text-white leading-tight mb-2 truncate">
                  {item.name}
                </h3>
                <div className="font-black text-xl mb-4 mt-auto dark:text-gray-200">
                  {item.price}
                </div>
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={index}
                className="bg-white dark:bg-brand-card-dark rounded-2xl p-3 shadow-sm flex items-center gap-4 hover:shadow-md transition cursor-pointer border border-gray-100 dark:border-gray-800"
              >
                ...
                <div className="flex-1 pr-2">
                  ...
                  <h3 className="font-extrabold text-sm leading-tight mb-1 text-gray-800 dark:text-gray-200">
                    {item.name}
                  </h3>
                  <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 mb-2 font-medium">
                    <span className="text-yellow-400 mr-1 text-sm">★</span> 4.8{" "}
                    <span className="ml-1 text-gray-400">(150)</span>
                  </div>
          ...
          <div className="bg-gradient-to-r from-brand-green/20 to-brand-green/40 dark:from-brand-green/10 dark:to-brand-green/20 rounded-3xl p-8 md:p-10 border border-brand-green/30 flex flex-col md:flex-row items-center justify-between shadow-sm">
            <div className="mb-6 md:mb-0 max-w-xl text-center md:text-left">
              <h2 className="text-3xl md:text-4xl font-black mb-3 text-gray-900 dark:text-white tracking-tight">
                30% OFF en tu primera compra
              </h2>
              <p className="text-gray-700 dark:text-gray-300 text-sm md:text-base font-medium">
                Usa el código{" "}
                <span className="font-black text-black bg-white dark:bg-gray-800 dark:text-white px-2 py-0.5 rounded shadow-sm mx-1">
                  FITLOOK30
                </span>{" "}
                al finalizar tu compra para canjear tu descuento. Válido en todo
                el catálogo AR.
              </p>
            </div>
