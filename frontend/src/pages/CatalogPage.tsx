            ...
            <aside className="w-full lg:w-64 flex-shrink-0">
              <div className="bg-white dark:bg-brand-card-dark rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-800">
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-2">
                    {["Hombre", "Mujer", "Unisex"].map((gender) => (
                      ...
                      >
                        <div
                          className={`w-4 h-4 rounded border flex items-center justify-center transition-colors ${selectedGender === gender ? "bg-brand-green border-brand-green" : "border-gray-300 dark:border-gray-600 group-hover:border-brand-green"}`}
                        >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                  <h4 className="text-xs font-bold text-gray-900 dark:text-gray-300 uppercase tracking-widest">
                    Solo en Stock
                  </h4>
                  <button
                  ...
                  >
                    <div
                      className={`w-3.5 h-3.5 bg-white rounded-full absolute top-0.5 transition-transform ${inStock ? "left-6" : "left-1"}`}
                    ></div>
                  </button>
                </div>
              </div>
            ...
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row justify-between items-center bg-white dark:bg-brand-card-dark rounded-xl p-4 mb-6 shadow-sm border border-gray-100 dark:border-gray-800">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <select className="text-sm font-bold bg-transparent dark:bg-brand-card-dark text-gray-900 dark:text-white border-none focus:ring-0 cursor-pointer">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    price: "$120.00",
                    img: "https://images.unsplash.com/photo-1460353581641-37baddab0fa2?w=400&q=80",
                    stock: "IN STOCK",
                  },
                  {
                    id: "11",
                  ...
                  },
                  {
                    ...
                    price: "$85.00",
                    img: "https://images.unsplash.com/photo-1521503862198-2ae9a997bbc9?w=400&q=80",
                    stock: "LIMITED",
                  },
                ].map((item, index) => (
                  <div
                  ...
                  >
                    <div className="relative bg-[#f4f5f7] dark:bg-gray-800 rounded-xl aspect-[4/5] mb-4 flex items-center justify-center overflow-hidden">
                      <span
                        className={`absolute top-3 left-3 px-2 py-1 text-[8px] font-black uppercase tracking-wider text-white rounded shadow-sm z-10 ${item.low ? "bg-red-500" : "bg-gray-900/70 dark:bg-black/50"}`}
                      >
                        {item.stock}
                      </span>
                      <button
                    ...
                    <div className="font-black text-lg mb-3 dark:text-gray-200">
                      {item.price}
                    </div>
                    ...
                    <div className="flex gap-1 mb-4 mt-auto">
                      {["S", "M", "L", "XL"].map((sz) => (
                        <span
                          key={sz}
                          className="w-5 h-5 flex items-center justify-center bg-gray-100 dark:bg-gray-700 rounded text-[9px] font-bold text-gray-600 dark:text-gray-300"
                        >
                          {sz}
                        </span>
                      ))}
