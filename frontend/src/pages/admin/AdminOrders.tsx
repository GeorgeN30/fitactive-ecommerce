                  ...
                  <tr className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="py-4 px-6 text-right">
                      <button
                        ...
                        aria-label={
                          expandedOrder === order.id ? "Contraer" : "Expandir"
                        }
                            ...
                            <div className="space-y-3">
                              {order.items.map((item, i) => {
                                const product = mockProducts.find(
                                  (p) =>
                                    p.sku === item.sku || p.name === item.name,
                                );
                                return (
                                  <div
                        ...
                        <div className="mt-5 pt-4 border-t border-slate-200">
                          ...
                          <div className="flex items-center gap-2">
                            {[
                              ...
                              >
                                <div
                                  className={`w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-bold ${i < 2 ? "bg-brand-green text-black" : "bg-slate-200 text-slate-500"}`}
                                >
                                  {i + 1}
                                </div>
                                ...
                                {i < 2 && (
                                  <i className="fa-solid fa-chevron-right text-[10px] text-slate-300 mx-1" />
                                )}
                              </div>
                            ))}
                          </div>
