    ...
    <AppLayout>
      <div className="bg-white dark:bg-brand-dark-bg min-h-screen py-8 font-sans text-gray-900 dark:text-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav
            className="flex text-xs font-medium text-gray-500 mb-8"
            ...
            <div className="w-full lg:w-3/5 flex flex-col-reverse sm:flex-row gap-4">
              <div className="flex sm:flex-col gap-3 overflow-x-auto sm:overflow-visible">
                {[1, 2, 3, 4].map((idx) => (
                  <button
                    key={idx}
                    className={`w-16 h-20 rounded-lg bg-[#f4f5f7] dark:bg-gray-800 flex items-center justify-center border-2 transition-all flex-shrink-0 overflow-hidden ${idx === 1 ? "border-brand-green" : "border-transparent hover:border-gray-300"}`}
                  >
                    <img
                      src={`https://images.unsplash.com/photo-1581655353564-df123a1eb820?w=100&q=80&sig=${idx}`}
                      alt="Thumb"
              ...
              <div className="flex-1 bg-[#f4f5f7] dark:bg-gray-800 rounded-2xl flex items-center justify-center p-8 overflow-hidden aspect-[4/5] sm:aspect-auto sm:min-h-[600px]">
                <img
                  src={product.img}
                  alt={product.name}
                  className="object-cover w-full h-full mix-blend-multiply dark:mix-blend-normal hover:scale-105 transition-transform duration-700"
                />
              </div>
            </div>
            ...
            <div className="w-full lg:w-2/5 flex flex-col">
              <div className="flex justify-between items-start mb-2">
                ...
                <div className="flex items-center text-xs font-medium">
                  ...
                  <span className="text-gray-400 ml-1 underline cursor-pointer">
                    (124 opiniones)
                  </span>
                </div>
              </div>
              ...
              <div className="text-2xl font-black text-gray-900 dark:text-gray-200 mb-6">
                ${product.price.toFixed(2)}
              </div>

              <p className="text-sm text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                Tee de compresión ergonómica diseñada para atletas de alta
                resistencia. Desarrollada con hilos inteligentes de microfibra
                que regulan la temperatura corporal en situaciones de alto
                esfuerzo.
              </p>
              ...
              <div className="mb-6">
                <div className="flex justify-between items-center mb-3">
                  ...
                  <a
                    href="#"
                    className="text-xs text-gray-500 underline hover:text-black dark:hover:text-white transition"
                  >
                    Guía de tallas
                  </a>
                </div>
              ...
              <div className="mb-8">
                ...
                <div className="flex gap-3">
                  {[
                    ...
                    >
                      <span
                        className={`w-full h-full rounded-full ${c.color} border border-gray-200 dark:border-gray-700`}
                      ></span>
                    </button>
                  ))}
                </div>
              ...
              <div className="flex gap-3 mb-4">
                <div className="flex items-center border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800">
                  <button
                    ...
                    className="w-10 h-12 flex items-center justify-center text-lg font-medium hover:text-brand-green transition"
                  >
                    -
                  </button>
          ...
          <div className="mb-16">
            <div className="border-b border-gray-200 dark:border-gray-800 flex gap-8 mb-6">
              {["Descripción", "Especificaciones", "Reseñas (124)"].map(
                (tab) => (
                  <button
                    key={tab}
                  ...
                  >
                    {tab}
                    {activeTab === tab && (
                      <div className="absolute bottom-0 left-0 w-full h-0.5 bg-gray-900 dark:bg-brand-green"></div>
                    )}
                  </button>
                ),
              )}
                ...
                <div className="grid sm:grid-cols-2 gap-y-4 gap-x-12">
                  {[
                    ...
                    <div key={idx} className="flex items-start">
                      <svg
                        className="w-4 h-4 text-brand-green mr-2 mt-0.5 flex-shrink-0"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
              ...
              {[
                {
                  ...
                  name: "Apex Performance Shorts",
                  price: "$45.00",
                  img: "https://images.unsplash.com/photo-1591557304192-35324d271638?w=400&q=80",
                },
                {
                  id: "3",
                  cat: "Ciclismo",
                  name: "Nova Carbon Windbreaker",
                  price: "$129.00",
                  img: "https://images.unsplash.com/photo-1622445272461-c458007e63d2?w=400&q=80",
                },
                {
                  id: "4",
                  cat: "CrossFit",
                ...
                },
                {
                  ...
                  name: "Zen Ultra Breathable Crop",
                  price: "$39.00",
                  img: "https://images.unsplash.com/photo-1608228079968-c76817032b90?w=400&q=80",
                },
              ].map((item, index) => (
                <div
                  key={index}
